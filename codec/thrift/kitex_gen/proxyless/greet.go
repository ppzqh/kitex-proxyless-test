...
type GreetService interface {
	...
	SayHi(ctx context.Context, request *HelloRequest) (r *HelloResponse, err error)
}
...
func (p *GreetServiceClient) SayHi(ctx context.Context, request *HelloRequest) (r *HelloResponse, err error) {
	var _args GreetServiceSayHiArgs
	_args.Request = request
	var _result GreetServiceSayHiResult
	if err = p.Client_().Call(ctx, "SayHi", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewGreetServiceProcessor(handler GreetService) *GreetServiceProcessor {
	...
	self.AddToProcessorMap("SayHi", &greetServiceProcessorSayHi{handler: handler})
	return self
}
...
type greetServiceProcessorSayHi struct {
	handler GreetService
}

func (p *greetServiceProcessorSayHi) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := GreetServiceSayHiArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := GreetServiceSayHiResult{}
	var retval *HelloResponse
	if retval, err2 = p.handler.SayHi(ctx, args.Request); err2 != nil {
...
type GreetServiceSayHiArgs struct {
	Request *HelloRequest `thrift:"request,1" json:"request"`
}

func NewGreetServiceSayHiArgs() *GreetServiceSayHiArgs {
	return &GreetServiceSayHiArgs{}
}

var GreetServiceSayHiArgs_Request_DEFAULT *HelloRequest

func (p *GreetServiceSayHiArgs) GetRequest() (v *HelloRequest) {
	if !p.IsSetRequest() {
		return GreetServiceSayHiArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *GreetServiceSayHiArgs) SetRequest(val *HelloRequest) {
	p.Request = val
}

var fieldIDToName_GreetServiceSayHiArgs = map[int16]string{
	1: "request",
}

func (p *GreetServiceSayHiArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *GreetServiceSayHiArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GreetServiceSayHiArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *GreetServiceSayHiArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewHelloRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
...
func (p *GreetServiceSayHiArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *GreetServiceSayHiArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *GreetServiceSayHiArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GreetServiceSayHiArgs(%+v)", *p)
}

func (p *GreetServiceSayHiArgs) DeepEqual(ano *GreetServiceSayHiArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GreetServiceSayHiArgs) Field1DeepEqual(src *HelloRequest) bool {
...
type GreetServiceSayHiResult struct {
	Success *HelloResponse `thrift:"success,0" json:"success,omitempty"`
}

func NewGreetServiceSayHiResult() *GreetServiceSayHiResult {
	return &GreetServiceSayHiResult{}
}

var GreetServiceSayHiResult_Success_DEFAULT *HelloResponse

func (p *GreetServiceSayHiResult) GetSuccess() (v *HelloResponse) {
	if !p.IsSetSuccess() {
		return GreetServiceSayHiResult_Success_DEFAULT
	}
	return p.Success
}
func (p *GreetServiceSayHiResult) SetSuccess(x interface{}) {
	p.Success = x.(*HelloResponse)
}

var fieldIDToName_GreetServiceSayHiResult = map[int16]string{
	0: "success",
}

func (p *GreetServiceSayHiResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GreetServiceSayHiResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GreetServiceSayHiResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *GreetServiceSayHiResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewHelloResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
...
func (p *GreetServiceSayHiResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *GreetServiceSayHiResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *GreetServiceSayHiResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GreetServiceSayHiResult(%+v)", *p)
}

func (p *GreetServiceSayHiResult) DeepEqual(ano *GreetServiceSayHiResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GreetServiceSayHiResult) Field0DeepEqual(src *HelloResponse) bool {
